...
import 'package:order_now_android/view/admin/room_book_admin.dart';
...
class AdminRoomsProvider extends ChangeNotifier {
...
//not Aavailble
  void NotAvailable(bool isAvailble) {
    ...
    if (filteredList1stFloor.isNotEmpty ||
      ...
      // NotAvailablecheck = false;//is it using
      notifyListeners();
            ...
            onTap: () {
              ...
              if (test == true) {
                ...
                Navigator.push(
                  ...
                  CupertinoPageRoute(
                    builder: (context) =>
                        AdminRoomBookPage(currentRoomData: mapofuserdetails),
                  ),
                );
              } else {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    ...
                    duration:
                        Duration(seconds: 1), // You can adjust the duration
                  ),
                );
