...
import 'package:order_now_android/view/admin/current_customer_edit_page.dart';
...
class CustomerDetailsAdminProvider extends ChangeNotifier {
        ...
        child: Padding(
          ...
          child: Bounceable(
            onTap: () {
              ...
              //   context,
              //   CupertinoPageRoute(
              //     builder: (context) => CurrentCustomerData(
              //         currentCustomerData: mapofuserdetails),
              //   ),
              // );
              Navigator.push(
                context,
                CupertinoPageRoute(
                    builder: (context) => CurrentCustomerEditPage(
                        currentCustomerData: mapofuserdetails)),
              );
...
//found bug on here and dormitory s changed the code
  // Future<void> loadRoomCustomers(BuildContext context) async {
  //   try {
  //     notifyListeners();
  //     RoomCustomers
  ...
  //           await Provider.of<RoomBookviewModel>(context, listen: false)
        ...
        if (room.catogary == 'dormitory' && room.isCustomerinRoom == true) {
          if (!isCheckoutTimePassed(room.checkoutdate, room.checkouttime)) {
            ...
            await automaticCustomerupdateForDormitory(context,
                name: room.name, uniqueID: room.uniqueID);
            await Provider.of<dormitoryBookviewModel>(context, listen: false)
                .UpdateAvailbility(context,
