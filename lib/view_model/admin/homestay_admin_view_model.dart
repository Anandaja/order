...
import 'package:order_now_android/view/admin/admin_homestay_book.dart';
...
class AdminHomestayProvider extends ChangeNotifier {
            ...
            onTap: () {
              ...
              if (test == true) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Homestay is is Currently Occupied'),
                    duration:
