...
// import 'package:jnn_erp/view_model/reception/dormitory_view_model.dart';
// import 'package:provider/provider.dart';
import 'package:uuid/uuid.dart';

class AdminDormitoryBookProvider extends ChangeNotifier {
...
//add ones
  ...
  //Update the Availability of dormitory
  Future<void> UpdateAvailbility(BuildContext context,
      {required String dormitoryno, required bool Availbility}) async {
    try {
      notifyListeners();
      QuerySnapshot querySnapshot = await dormitorycollection
          .where('dormitoryno', isEqualTo: dormitoryno)
          .get();
      if (querySnapshot.docs.isNotEmpty) {
        ...
        dormitorycollection
          ...
          // Provider.of<DormitoryProvider>(context, listen: false)
          //     .loadDormitorys(); // To refresh the page to get the realtime dormitory data data on all dormitory page
          // Provider.of<CustomerProvider>(context, listen: false)
          //     .loadDormitoryCustomers(
          //         context); //for the refresh of customerdetails page dormitory section
          if (kDebugMode) {
            print('Dormitory availability changed to $Availbility');
          }
        });
      }
  ...
  Future<void> BookDormitory(
    ...
    try {
      ...
      await customercollection.add({
        'uniqueID': uniqueID,
        'roomnoORname': roomnoORname, //dormitory no
        'rate': Rate,
        'floor': Floor,
        'name': name,
        'address': address,
      ...
      if (kDebugMode) {
        print('His uniqueID is $uniqueID');
      }
    } catch (e) {
...
//text to image
  ...
  //snackbar if no text from the image
