...
class AdminHomestayBookPage extends StatefulWidget {
  const AdminHomestayBookPage({
    super.key,
  ...
  @override
  AdminHomestayBookPageState createState() => AdminHomestayBookPageState();
}

class AdminHomestayBookPageState extends State<AdminHomestayBookPage> {
  ...
  void initState() {
    ...
    final provider =
        Provider.of<AdminHomestayBookProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    Provider.of<AdminHomestayBookProvider>(context, listen: false).avilable =
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        key: Provider.of<AdminHomestayBookProvider>(context, listen: false)
            .scaffoldKey,
        ...
        body: Consumer<AdminHomestayBookProvider>(
                                              ...
                                              try {
                                                ...
                                                await consumer.BookHomestay(
                                                    ...
                                                    .then((value) => Navigator
                                                            .of(context)
                                                        .pop([Provider.of<AdminHomestayProvider>(context, listen: false).DetailsLoader()]));
                                              } finally {
                                                consumer.isProcessing = false;
                                              }
                                            } else {
