...
class RoomCreationPage extends StatefulWidget {
  ...
  @override
  RoomCreationPageState createState() => RoomCreationPageState();
}

class RoomCreationPageState extends State<RoomCreationPage> {
  Future<bool> showExitPopup() async {
    Provider.of<RoomCreationProvider>(context, listen: false).clearingfiealds();
    Provider.of<RoomCreationProvider>(context, listen: false).isimageAdded =
        false;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(body:
          Consumer<RoomCreationProvider>(builder: (context, consumer, child) {
                                      ...
                                      if (consumer.formkey4fiealds.currentState!
                                        ...
                                        try {
                                          ...
                                          if (kDebugMode) {
                                            ...
                                            print(
                                                'Type ${consumer.currentSelectedroomType}');
                                            print(
                                            ...
                                            print(
                                                'download url : ${consumer.downloadURL}');
                                          }

                                          // create the room
                                          await consumer.CreateNewRoom(
                                                  Rate: consumer
                                                      .ratecontroller.text,
                                                  roomtype: consumer
