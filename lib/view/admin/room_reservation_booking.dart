...
class RoomReservationBooking extends StatefulWidget {
  final DateTime CurrentDate;

  const RoomReservationBooking(
      {super.key,
  ...
  @override
  RoomReservationBookingState createState() => RoomReservationBookingState();
}

class RoomReservationBookingState extends State<RoomReservationBooking> {
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Provider.of<RoomRservationBookingProvider>(context,
                          listen: false)
                      .clearingfiealds();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Consumer<RoomRservationBookingProvider>(
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                  (BuildContext context, int index) {
                    ...
                    String roomtype =
                        widget.ReservedRoomList[index]['roomtype'];
                    String roomno =
                              ...
                              : () async {
                                  connectivity
                                    ...
                                    if (value == ConnectivityResult.none) {
                                      Provider.of<RoomReservationListProvider>(
                                              context,
                                              listen: false)
                                          .ReserveRoomList
                                          .clear();
                                      ...
                                      if (consumer.textformkey.currentState!
                                        ...
                                        try {
                                          ...
                                          await Provider.of<CalenderPageProvider>(
                                                  context,
                                                  listen: false)
                                              .ReserveBooking(context,
