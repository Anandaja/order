...
class HomestayCreationPage extends StatefulWidget {
  const HomestayCreationPage({super.key});

  @override
  HomestayCreationPageState createState() => HomestayCreationPageState();
}

class HomestayCreationPageState extends State<HomestayCreationPage> {
  Future<bool> showExitPopup() async {
    Provider.of<HomestayCreationProvider>(context, listen: false)
        .clearingfiealds();
    Provider.of<HomestayCreationProvider>(context, listen: false).isimageAdded =
        false;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(body: Consumer<HomestayCreationProvider>(
                                  ...
                                  : () async {
                                      if (consumer.formkey4fiealds.currentState!
                                        ...
                                        try {
                                          ...
                                          if (kDebugMode) {
                                            print(consumer.namecontoller.text);
                                          ...
                                          await consumer.CreateNewHomestay(
                                                  Rate: consumer
                                                      .ratecontroller.text,
                                                  HomestayName: consumer
                                                      .namecontoller.text,
