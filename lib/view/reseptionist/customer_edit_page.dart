...
class CustomerEditPage extends StatefulWidget {
  ...
  @override
  CustomerEditPageState createState() => CustomerEditPageState();
}

class CustomerEditPageState extends State<CustomerEditPage> {
  ...
  void initState() {
    final provider =
        Provider.of<CustomerDetailEditpageProvider>(context, listen: false);
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Provider.of<CustomerDetailEditpageProvider>(context,
                          listen: false)
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Consumer<CustomerDetailEditpageProvider>(
                            ...
                            if (connector.textformkey.currentState!
                              ...
                              if (connector.areChangesMade) {
                                try {
                                  ...
                                  if (kDebugMode) {
                                    print(connector.CheckIndatecontroller.text);
                                  }
                                  if (kDebugMode) {
                                    print(connector.checkINTimecontroller.text);
                                  }
                                  if (kDebugMode) {
                                    print(
                                        connector.Checkoutdatecontroller.text);
                                  }
                                  if (kDebugMode) {
                                    print(
                                        connector.checkOUTTimecontroller.text);
                                  }
                                  if (kDebugMode) {
                                  ...
                                  await connector.UpdateCustomerData(context,
                                          ...
                                          Newname:
                                              connector.namecontroller.text,
                                          address:
                                              connector.addresscontroller.text,
                                          mobilenumber: connector
                                              .phonenumbercontroller.text,
                                          noofpeople:
                                              connector.peoplecontroller.text,
                                          proof: connector.ischangedProof
                                              ? connector.currentSelectedproof
                                              : connector.proofInitialValue,
                                          purpose: connector.ischangedPurpose
                                              ? connector.currentSelectedPurpose
                                              : connector.purposeInitialValue,
