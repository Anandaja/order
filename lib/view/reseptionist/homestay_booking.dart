...
class HomestayBookPage extends StatefulWidget {
  const HomestayBookPage({
    super.key,
    required this.currentHomestayData,
  });
  final Map<String, dynamic> currentHomestayData;

  @override
  HomestayBookPageState createState() => HomestayBookPageState();
}

class HomestayBookPageState extends State<HomestayBookPage> {
  ...
  void initState() {
    ...
    final provider = Provider.of<HomestayBookProvider>(context, listen: false);
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Provider.of<HomestayBookProvider>(context, listen: false)
                      .clearingfiealds();
  ...
  Widget build(BuildContext context) {
    Provider.of<HomestayBookProvider>(context, listen: false).avilable =
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        key: Provider.of<HomestayBookProvider>(context, listen: false)
            .scaffoldKey,
        ...
        body: Consumer<HomestayBookProvider>(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                '${widget.currentHomestayData['name']}',
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                              ...
                                              child: consumer.testFormFieald(
                                                  ...
                                                  'Rate ${widget.currentHomestayData['rate']}',
                                                  TextInputType.number,
                                                  false,
                                                  () {},
                                                  false,
                                    ...
                                    : () async {
                                        connectivity
                                          ...
                                          if (value ==
                                            ...
                                            NoInternetDialogReception(context);
                                              ...
                                              try {
                                                ...
                                                await consumer.BookHomestay(
                                                    ...
                                                    .then((value) => Navigator
                                                            .of(context)
                                                        .pop([Provider.of<HomestayProvider>(context, listen: false).DetailsLoader()]));
                                              } finally {
                                                consumer.isProcessing = false;
                                              }
                                            } else {
