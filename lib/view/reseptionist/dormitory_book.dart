...
class DormitoryBookPage extends StatefulWidget {
  const DormitoryBookPage({
    super.key,
    required this.currentDormitoryData,
  });
  final Map<String, dynamic> currentDormitoryData;
  @override
  DormitoryBookPageState createState() => DormitoryBookPageState();
}

class DormitoryBookPageState extends State<DormitoryBookPage> {
  ...
  void initState() {
    ...
    final provider = Provider.of<dormitoryBookProvider>(context, listen: false);
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Provider.of<dormitoryBookProvider>(context, listen: false)
                      .clearingfiealds();
  ...
  Widget build(BuildContext context) {
    Provider.of<dormitoryBookProvider>(context, listen: false).avilable =
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        key: Provider.of<dormitoryBookProvider>(context, listen: false)
            .scaffoldKey,
        ...
        body: Consumer<dormitoryBookProvider>(
