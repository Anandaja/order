...
class RoomBookPage extends StatefulWidget {
  const RoomBookPage({super.key, required this.currentRoomData});
  final Map<String, dynamic> currentRoomData;
  @override
  RoomBookPageState createState() => RoomBookPageState();
}

class RoomBookPageState extends State<RoomBookPage> {
  ...
  void initState() {
    ...
    final provider = Provider.of<RoomBookProvider>(context, listen: false);
            ...
            actions: [
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Provider.of<RoomBookProvider>(context, listen: false)
                      .clearingfiealds();
  ...
  Widget build(BuildContext context) {
    Provider.of<RoomBookProvider>(context, listen: false).avilable =
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        key: Provider.of<RoomBookProvider>(context, listen: false)
        ...
        // extendBodyBehindAppBar: true,
        body: Consumer<RoomBookProvider>(builder: (context, connector, child) {
          return ListView(
